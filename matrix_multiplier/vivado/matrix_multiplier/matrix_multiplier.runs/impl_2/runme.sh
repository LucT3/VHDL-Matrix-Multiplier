...
HD_PWD='C:/Users/Asus/Desktop/final/matrix_multiplier/matrix_multiplier.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log MatrixMultiplierArchitecture.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MatrixMultiplierArchitecture.tcl -notrace
