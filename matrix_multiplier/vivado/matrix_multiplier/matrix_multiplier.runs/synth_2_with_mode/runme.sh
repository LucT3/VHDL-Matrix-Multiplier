...
HD_PWD='C:/Users/Asus/Desktop/final/matrix_multiplier/matrix_multiplier.runs/synth_2_with_mode'
cd "$HD_PWD"
...
EAStep vivado -log MatrixMultiplierArchitecture.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MatrixMultiplierArchitecture.tcl
